<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:83:"E:\75phpStudy\XiangMu\hometpshop75\public/../application/home\view\Login\login.html";i:1569172543;}*/ ?>
<!DOCTYPE html>
<html>
	...
	<div class="login-box">
		...
		<div class="loginArea">
						...
						<div id="profile" class="tab-pane  active">
							<form class="sui-form" action="<?php echo url('home/Login/dologin'); ?>" method="post">
								...
								<div class="input-prepend"><span class="add-on loginpwd"></span>
									<input id="prependedInput" type="password" placeholder="请输入密码" class="span2 input-xfat" name="passwd">
								</div>
								<div class="setting">
          ...
          自动登录
								...
								<div class="logined">
									<a class="sui-btn btn-block btn-xlarge btn-danger"  target="_blank">登&nbsp;&nbsp;录</a>
								</div>
							</form>
							<div class="otherlogin">
								<div class="types">
									<ul>
										<li><a href="/plugin/qq/Connect2.1/example/oauth/index.php"><img src="/static/home/img/qq.png" width="35px" height="35px" /></a></li>
