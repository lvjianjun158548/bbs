<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:96:"E:\75phpStudy\XiangMu\hometpshop75\public/../application/home\view\Cart_controller\cart_add.html";i:1569402897;s:68:"E:\75phpStudy\XiangMu\hometpshop75\application\home\view\layout.html";i:1570630639;}*/ ?>
<!DOCTYPE html>
<html>
        ...
        <div class="py-container ">
            ...
            <div class="goods">
                ...
                <div class="right-gocart">
                    <a href="<?php echo url('home/GoodsController/detail',['id'=>$goods['id']]); ?>" class="sui-btn btn-xlarge">查看商品详情</a>
                    <a href="<?php echo url('home/CartController/cart_list'); ?>" class="sui-btn btn-xlarge btn-danger " target="_blank">去购物车结算 > </a>
                </div>
            </div>
            </div>
    </div>
