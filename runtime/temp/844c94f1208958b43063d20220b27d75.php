<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:94:"E:\75phpStudy\XiangMu\hometpshop75\public/../application/home\view\Order_controller\order.html";i:1569512542;s:68:"E:\75phpStudy\XiangMu\hometpshop75\application\home\view\layout.html";i:1570630639;}*/ ?>
<!DOCTYPE html>
<html>
...
<body>
	...
	<div class="cart py-container">
					...
					<div class="step-cont">
						<ul class="send-detail">
							<li>
								...
								<div class="sendGoods">
									<span>商品清单：</span>
									<?php foreach($cart_data['cart_data'] as $v): ?>
										<ul class="yui3-g">
											<li class="yui3-u-1-6">
											...
											<li class="yui3-u-1-12">
												<div class="num"><?php echo $v['number']; ?></div>
											</li>
											<li class="yui3-u-1-12">
												<div class="exit"><?php if(($v['goods']['goods_number'] > $v['number'])): ?>有货<?php else: ?>没有货<?php endif; ?></div>
											</li>
										</ul>
									<?php endforeach; ?>
								</div>
		...
		<div class="order-summary">
			<div class="static fr">
				<div class="list">
					<span><i class="number"><?php echo $cart_data['total_number']; ?></i>件商品，总商品金额</span>
					<em class="allprice">¥<?php echo $cart_data['total_price']; ?></em>
				</div>
				<div class="list">
					<span>返现：</span>
		...
		<div class="clearfix trade">
			<div class="fc-price">应付金额:　<span class="price">¥<?php echo $cart_data['total_price']; ?></span></div>
	...
	<form action="<?php echo url('home/OrderController/save'); ?>" method="post" id="OrderForm">
	...
	<script type="text/javascript">
		$(function(){
			...
			$('.btn-xlarge').click(function(){
				var id = $('.addr-item').find('.name.selected').attr('address_id');
