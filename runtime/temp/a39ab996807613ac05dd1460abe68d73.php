<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:97:"E:\75phpStudy\XiangMu\hometpshop75\public/../application/home\view\Cart_controller\cart_list.html";i:1570693019;s:68:"E:\75phpStudy\XiangMu\hometpshop75\application\home\view\layout.html";i:1570630639;}*/ ?>
<!DOCTYPE html>
<html>
				...
				<div class="cart-body">
					...
					<div class="cart-list">
						<ul class="goods-list yui3-g" cart_id="<?php echo $v['id']; ?>" number="<?php echo $v['number']; ?>">
							...
							<li class="yui3-u-1-8">
								<a href="javascript:void(0)" class="delete" cart_id="<?php echo $v['id']; ?>">删除</a><br />
...
<script type="text/javascript">
	$(function () {
		...
		var change_num = function (number, element) {
			var data = {
				'cart_id': $(element).closest('ul').attr('cart_id'),
				'number': number
			}
			$.ajax({
				'url': "<?php echo url('home/CartController/changeNum'); ?>",
				'type': 'post',
				'data': data,
				'dataType': 'json',
		...
		$('.check_all').change(function () {
			...
			$.ajax({
				'url':"<?php echo url('home/CartController/changeStatu'); ?>",
				'type':'post',
				'dataType':'json',
				'data':data,
				'success':function(res){
		...
		$('.delete').click(function () {
			...
			var that = $(this);
			$.ajax({
				'url': "<?php echo url('home/CartController/cartDel'); ?>",
				'type': 'post',
				'data': data,
				'data_type': 'json',
				'success': function (res) {
			...
			//location.href = "<?php echo url('home/CartController/cart_list'); ?>";
		...
		$('.sum-btn').click(function () {
			...
			//跳转到结算页面
			location.href = "<?php echo url('home/OrderController/create'); ?>";
		});
	})
</script>
</body>
