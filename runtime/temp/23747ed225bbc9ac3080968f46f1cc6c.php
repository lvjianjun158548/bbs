<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:95:"E:\75phpStudy\XiangMu\hometpshop75\public/../application/home\view\Goods_controller\detail.html";i:1569328952;s:68:"E:\75phpStudy\XiangMu\hometpshop75\application\home\view\layout.html";i:1570630639;}*/ ?>
<!DOCTYPE html>
<html>
	...
	<div id="item">
		...
		<div class="product-info">
					...
					<div class="spec-scroll">
						...
						<div class="items">
							<ul>
								...
								<li><img src="<?php echo $v['pics_sma']; ?>" bimg="<?php echo $v['pics_big']; ?>" onmousemove="preview(this)" />
								</li>
								<?php endforeach; ?>
							</ul>
						</div>
			...
			<div class="fr itemInfo-wrap">
				...
				<div class="news"><span><?php echo $goods['goods_remark']; ?></span></div>
				<div class="summary">
					<div class="summary-wrap">
						...
						<div class="fl price">
							<i>¥</i>
							<em id="goods_price"><?php echo $goods['price']; ?></em>
							<span>降价通知</span>
						</div>
						<div class="fr remark">
				...
				<div class="clearfix choose">
					<div id="specification" class="summary-wrap clearfix">
						...
						<dl>
							...
							<?php foreach($v['spec_val'] as $k=>$v): ?>
							<dd><a href="javascript:;" value_id="<?php echo $v['id']; ?>"
									class="<?php if(($k == 0)): ?>selected<?php endif; ?>"><?php echo $v['spec_value']; ?><span
					...
					<div class="summary-wrap">
						...
						<div class="fl">
							<ul class="btn-choose unstyled">
								<li>
									<a href="javascript:;" target="_blank" class="sui-btn  btn-danger addshopcar" id="addshopcar">加入购物车</a>
								</li>
							</ul>
						</div>
					</div>
...
<form action="<?php echo url('home/CartController/addCart'); ?>" method="post" style="display: none">
	<input type="hidden" name="number" value="">
	<input type="hidden" name="goods_id" value="<?php echo $goods['id']; ?>">
	<input type="hidden" name="goods_spec_id" value="">
</form>
<!--购物车单元格 模板-->
...
<script type="text/javascript">
	...
	$(function () {
		...
		$('#specification').find('a').click(function () {
			...
			if (value_ids_map[spec_ids]) {
				var price = value_ids_map[spec_ids]['price'];
				//console.log(price);
		...
		$("#addshopcar").click(function(){
			...
			spec_ids = spec_ids.slice(0, -1);
			if(value_ids_map[spec_ids]){
				var id = value_ids_map[spec_ids]['id'];
				//alert(id);
			}
			$('input[name=goods_spec_id]').val(id);
