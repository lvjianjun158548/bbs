<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:92:"E:\75phpStudy\XiangMu\hometpshop75\public/../application/home\view\Order_controller\pay.html";i:1569591626;s:68:"E:\75phpStudy\XiangMu\hometpshop75\application\home\view\layout.html";i:1570630639;}*/ ?>
<!DOCTYPE html>
<html>
		...
		<div class="checkout-steps">
			...
			<div class="step-cont">
				<ul class="payType">
					...
					<li class="<?php if(($v['pay_code'] == 'alipay')): ?>selected<?php endif; ?>" pay_type="<?php echo $v['pay_code']; ?>"><img
							src="<?php echo $v['logo']; ?>"></li>
					<?php endforeach; ?>
			...
			<div class="submit sui-text-center">
				<a class="sui-btn btn-danger btn-xlarge" id="submit" href="javascript:;" target="_blank">立即支付</a>
			</div>
			<div class="otherpay">
				<div class="step-tit">
					<h5>其他支付方式</h5>
...
<form action="<?php echo url('home/OrderController/toPay'); ?>" style="display: none" method="post">
...
<script type="text/javascript">
	$(function () {
		...
		$("#submit").click(function () {
			//alert('34543');
			var pay_type = $('ul.payType li.selected').attr('pay_type');
